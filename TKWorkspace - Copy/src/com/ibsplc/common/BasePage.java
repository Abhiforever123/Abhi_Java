...
//                click(by);
            ...
            if (!waitForElementVisible(by).isSelected()) {
//                click(element);
                waitForElement(by).click();
            }
        }
...
//        int tableRowCount = tableBody.findElements(By.tagName("tr")).size();
        ...
        ListIterator<WebElement> listIterator = null;
        driver.manage().timeouts().implicitlyWait(0, TimeUnit.SECONDS);
        try {
            listIterator = table.findElements(By.xpath(".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + columnNo + "]")).listIterator();
        } catch (StaleElementReferenceException e) {
            minWait();
            listIterator = table.findElements(By.xpath(".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + columnNo + "]")).listIterator();
        }
        ...
        while (listIterator.hasNext()) {
            tableColsVals.add(listIterator.next().getText());
        }
...
//            String columnText = tableBody.findElements(By.tagName("tr")).get(i).findElements(By.tagName("td")).get(columnNo - 1).getText();
    ...
    protected int getTableRowCount(By by) {
        WebElement table = waitForElement(by);
        WebElement tableBody = table.findElement(By.tagName("tbody"));
        int tableRowCount = tableBody.findElements(By.xpath("./tr[not(@style) or not(contains(@style,'display:none'))]")).size();
...
//        return columns.get(columnNo - 1).getText();
        ...
        try {
            return waitForElementVisible(by).findElement(By.xpath(xpath)).getText();
        } catch (StaleElementReferenceException e) {
            return waitForElementVisible(by).findElement(By.xpath(xpath)).getText();
        }
...
//    	List<WebElement> columns;
        ...
        table = waitForElementVisible(by);
        xpath = ".//tbody/tr[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + rowNo + "]/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + columnNo + "]";
...
//            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "]/descendant-or-self::node()[contains(text(),'" + value + "')]/ancestor-or-self::node()/preceding-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (valueClo - chkBxCol) + "]/input";
            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "][contains(.,'" + value + "')]/preceding-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (valueClo - chkBxCol) + "]//input[@type='checkbox']";
        } else {
//            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "]/descendant-or-self::node()[contains(text(),'" + value + "')]/ancestor-or-self::node()/following-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (chkBxCol - valueClo) + "]/input";
            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "][contains(.,'" + value + "')]/following-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (chkBxCol - valueClo) + "]//input[@type='checkbox']";
        }
        try {
            scrollToView(table.findElement(By.xpath(xpath)));
            minWait();
...
//            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "]/descendant-or-self::node()[contains(text(),'" + value + "')]/ancestor-or-self::node()/preceding-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (valueClo - chkBxCol) + "]/input";
            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo1 + "][contains(.,'" + value1 + "')]/following-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (valueClo2 - valueClo1) + "][contains(.,'" + value2 + "')]/preceding-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (valueClo2 - chkBxCol) + "]//input[@type='checkbox']";


        } else {
//            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "]/descendant-or-self::node()[contains(text(),'" + value + "')]/ancestor-or-self::node()/following-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (chkBxCol - valueClo) + "]/input";
            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo1 + "][contains(.,'" + value1 + "')]/following-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (valueClo2 - valueClo1) + "][contains(.,'" + value2 + "')]/following-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (chkBxCol - valueClo2) + "]//input[@type='checkbox']";
        }
        try {
            scrollToView(table.findElement(By.xpath(xpath)));
            minWait();
...
//        check(table.findElement(By.xpath(xpath)));
    ...
    protected void tblSetTextByMultipleColValue(By tblLocator, int inputCol, int valueClo1, int valueClo2, String value1, String value2, String text) {

        WebElement table = waitForElement(tblLocator);

        String xpath;
        if ((valueClo2 - inputCol) > 0) {
//            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "]/descendant-or-self::node()[contains(text(),'" + value + "')]/ancestor-or-self::node()/preceding-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (valueClo - inputCol) + "]/input";
            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo1 + "][contains(.,'" + value1 + "')]/following-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (valueClo2 - valueClo1) + "][contains(.,'" + value2 + "')]/preceding-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (valueClo2 - inputCol) + "]//input";


        } else {
//            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "]/descendant-or-self::node()[contains(text(),'" + value + "')]/ancestor-or-self::node()/following-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (inputCol - valueClo) + "]/input";
            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo1 + "][contains(.,'" + value1 + "')]/following-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (valueClo2 - valueClo1) + "][contains(.,'" + value2 + "')]/following-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (inputCol - valueClo2) + "]//input";
        }
        try {
            scrollToView(table.findElement(By.xpath(xpath)));
            minWait();
        ...
        table.findElement(By.xpath(xpath)).sendKeys(text);
...
//            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "]/descendant-or-self::node()[contains(text(),'" + value + "')]/ancestor-or-self::node()/preceding-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (valueClo - linkCol) + "]/input";
            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "][contains(.,'" + value + "')]/preceding-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (valueClo - linkCol) + "]//a";
        } else {
//            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "]/descendant-or-self::node()[contains(text(),'" + value + "')]/ancestor-or-self::node()/following-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (linkCol - valueClo) + "]/input";
            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "][contains(.,'" + value + "')]/following-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (linkCol - valueClo) + "]//a";
        }
        try {
            scrollToView(table.findElement(By.xpath(xpath)));
            minWait();
    ...
    protected boolean tblchkBxEnabledByColValue(By tblLocator, int chkBx, int valueClo, String value) {
        ...
        String xpath;
        if ((valueClo - chkBx) > 0) {
//            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "]/descendant-or-self::node()[contains(text(),'" + value + "')]/ancestor-or-self::node()/preceding-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (valueClo - chkBx) + "]/input";
            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "][contains(.,'" + value + "')]/preceding-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (valueClo - chkBx) + "]//input";
        } else {
//            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "]/descendant-or-self::node()[contains(text(),'" + value + "')]/ancestor-or-self::node()/following-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (chkBx - valueClo) + "]/input";
            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "][contains(.,'" + value + "')]/following-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (chkBx - valueClo) + "]//input";
        }
        try {
            scrollToView(table.findElement(By.xpath(xpath)));
            minWait();
...
//            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "]/descendant-or-self::node()[contains(text(),'" + value + "')]/ancestor-or-self::node()/preceding-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (valueClo - txtCol) + "]";
            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "][contains(.,'" + value + "')]/preceding-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (valueClo - txtCol) + "]//input";

        } else {
//            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "]/descendant-or-self::node()[contains(text(),'" + value + "')]/ancestor-or-self::node()/following-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (txtCol - valueClo) + "]";
            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "][contains(.,'" + value + "')]/following-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (txtCol - valueClo) + "]//input";
        }
        try {
            scrollToView(table.findElement(By.xpath(xpath)));
            minWait();
...
//            xpath = ".//tbody/tr/td[" + valueClo + "]/descendant-or-self::node()[contains(text(),'" + value + "')]/ancestor-or-self::node()/preceding-sibling::td[" + (valueClo - txtCol) + "]";
            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "][contains(.,'" + value + "')]/preceding-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (valueClo - txtCol) + "]";
        } else {
//            xpath = ".//tbody/tr/td[" + valueClo + "]/descendant-or-self::node()[contains(text(),'" + value + "')]/ancestor-or-self::node()/following-sibling::td[" + (txtCol - valueClo) + "]";
            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "][contains(.,'" + value + "')]/following-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (txtCol - valueClo) + "]";
        }
        try {
            scrollToView(table.findElement(By.xpath(xpath)));
            element = table.findElement(By.xpath(xpath));
            minWait();
        } catch (StaleElementReferenceException e) {
            scrollToView(table.findElement(By.xpath(xpath)));
            element = table.findElement(By.xpath(xpath));
...
//            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "]/descendant-or-self::node()[contains(text(),'" + value + "')]/ancestor-or-self::node()/preceding-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (valueClo - listCol) + "]";
            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "][contains(.,'" + value + "')]/preceding-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (valueClo - listCol) + "]//select";
        } else {
//            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "]/descendant-or-self::node()[contains(text(),'" + value + "')]/ancestor-or-self::node()/following-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (listCol - valueClo) + "]";
            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "][contains(.,'" + value + "')]/following-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (listCol - valueClo) + "]//select";
        }
        try {
            scrollToView(table.findElement(By.xpath(xpath)));
        } catch (StaleElementReferenceException e) {
...
//            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "]/descendant-or-self::node()[contains(text(),'" + value + "')]/ancestor-or-self::node()/following-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (txtCol - valueClo) + "]";
    ...
    /**
     * Used to scroll the element located by locator
     *
     * @param locator
     * @return element
     * @autor A-7681
     */
    protected void scrollVerticallyBy(By locator,String offset) {
//        javaScriptExecute("arguments[0].scrollBy(0," + offset + ");",driver.findElement(locator));
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollBy(0," + offset + ");", driver.findElement(locator));
        return;
    }
    ...
    /**
     * reads text value from a specific column
     * @author A-8260
     * @return
     */
    protected String getTextByColumnNumber(By tblLocator, int value)
    {
    	WebElement table = waitForElement(tblLocator);
    	String xpath;
    	xpath=".//tbody/tr/td["+value+"]";
    	try {
            scrollToView(table.findElement(By.xpath(xpath)));
        } catch (StaleElementReferenceException e) {
            table = waitForElement(tblLocator);
...
//        WebElement elem = wait.until(ExpectedConditions.refreshed(ExpectedConditions.elementToBeClickable(element)));
	 ...
	 * This method wait until the page completely load
	 */
	...
	/**
	 * @author A-8260
	 * enters the input using java script executor
	 * @param by
	 * @param value
	 */
    ...
    protected String tblGetFieldValueByColValue(By tblLocator, int fieldCol, int valueClo, String value) {
        ...
        if ((valueClo - fieldCol) > 0) {
            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "][contains(.,'" + value + "')]/preceding-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (valueClo - fieldCol) + "]/input";
        } else {
            xpath = ".//tbody/tr/td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + valueClo + "][contains(.,'" + value + "')]/following-sibling::td[(not(@style) or not(contains(@style,'display: none'))) and (not(@class) or not(contains(@class,'display-none')))][" + (fieldCol - valueClo) + "]/input";
        }
        try {
            scrollToView(table.findElement(By.xpath(xpath)));
            minWait();
     ...
     */
    public void waitForPageActionsToComplete() {
